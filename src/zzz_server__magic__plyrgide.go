...
func nox_xxx_netReportGuideAward_4D8000(a1 int32, a2 int8, a3 int8, a4 int32) int32 {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&4 != 0 {
		...
		*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 0)) = 209
		*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 2)) = uint8(a3)
		if a4 != 0 {
			*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 2)) = uint8(int8(int32(a3) | 128))
		}
...
func nox_xxx_awardBeastGuide_4FAE80_magic_plyrgide(a1 int32, a2 int32, a3 int32) int32 {
	...
	if a2 <= 0 || a2 >= 41 {
		v16 = strMan.GetStringInFile("AwardGuideError", "C:\\NoxPost\\src\\Server\\Magic\\PlyrGide.c")
	...
	*v7 = 1
	...
	if *memmap.PtrUint32(0x587000, 216292) != 0 {
		for {
			...
			if uint32(a2) == **(**uint32)(unsafe.Pointer(v8)) {
				v10 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(uint32(0))*1)))
				v11 = (*int32)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(uint32(0))*1))))
				if v10 != 0 {
					for {
						*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v4 + 276))) + uint32(v10*4) + 4244))) = 1
						...
						v10 = *(*int32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(int32(0))*1))
			...
			v12 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v8))), unsafe.Sizeof(uint32(0))*1))))
	...
	if a3 != 0 {
		for i = (*byte)(unsafe.Pointer(nox_common_playerInfoGetFirst_416EA0())); i != nil; i = (*byte)(unsafe.Pointer(nox_common_playerInfoGetNext_416EE0((*nox_playerInfo)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(i))))))))) {
			v14 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), unsafe.Sizeof(uint32(0))*514))))
			if v14 != v3 {
				if v14 != 0 {
