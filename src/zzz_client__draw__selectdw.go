...
func nox_video_drawCursorSelectCircle_4773C0(a1p *nox_draw_viewport_t) {
	...
	if dword_5d4594_1096640 != nil {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(uint32(uintptr(dword_5d4594_1096640)) + 112))))&6 != 0 && sub_495A80(int32(*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(dword_5d4594_1096640)) + 128))))) == 0 {
			v4 = randomIntMinMax(0, 1)
			if v4 == 0 {
		...
		v3 = a1
	LABEL_15:
		v5 = int32(*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(dword_5d4594_1096640)) + 112))))
		if (v5 & 512) == 0 {
