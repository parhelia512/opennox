...
func nox_xxx_drawLightningStep_4BB070(a1 int32, a2 int32) int32 {
	...
	if !v3 {
		...
		*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v24))), unsafe.Sizeof(uint16(0))*0)) = uint16(int16(v15*randomIntMinMax(int32(-dword_5d4594_1316476), *(*int32)(unsafe.Pointer(&dword_5d4594_1316476)))/v14 + ((int32(int16(a1)) + int32(int16(a2))) >> 1)))
		*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v24))), unsafe.Sizeof(uint16(0))*1)) = uint16(int16(v15*randomIntMinMax(int32(-dword_5d4594_1316476), *(*int32)(unsafe.Pointer(&dword_5d4594_1316476)))/v14 + ((int32(*(*int16)(unsafe.Add(unsafe.Pointer((*int16)(unsafe.Pointer(&a1))), unsafe.Sizeof(int16(0))*1))) + int32(*(*int16)(unsafe.Add(unsafe.Pointer((*int16)(unsafe.Pointer(&a2))), unsafe.Sizeof(int16(0))*1)))) >> 1)))
	...
	if *memmap.PtrUint32(6112660, 1316508) != 0 {
		v23 = int32(*memmap.PtrUint8(6112660, 1316420)) + 48
		sub_434040(*memmap.PtrInt32(6112660, 1316440))
		sub_434080(12)
		...
		sub_434040(*(*int32)(unsafe.Pointer(&dword_5d4594_1316472)))
		sub_434080(3)
		v4 = int32(*(*int16)(unsafe.Add(unsafe.Pointer((*int16)(unsafe.Pointer(&a1))), unsafe.Sizeof(int16(0))*1)))
		v5 = int32(int16(a1))
		nox_client_drawAddPoint_49F500(int32(int16(a1)), int32(*(*int16)(unsafe.Add(unsafe.Pointer((*int16)(unsafe.Pointer(&a1))), unsafe.Sizeof(int16(0))*1))))
	...
	v8 = *memmap.PtrUint8(6112660, 1316420)
	v25 = 1
	if (int32(*memmap.PtrUint8(6112660, 1316420)) & 254) > 2 {
		v19 = v7 + 1
		v21 = v5 + 1
		v17 = v4 + 1
		v27 = v6 + 1
		for {
			...
			v19++
			v25++
			if v25 >= (int32(*memmap.PtrUint8(6112660, 1316420)) >> 1) {
				break
			}
		}
	}
	...
	for {
		...
		v26++
		v20--
		if v26 >= (int32(*memmap.PtrUint8(6112660, 1316420)) >> 1) {
			break
		}
	}
	return int32(func() uint32 {
...
func nox_xxx_lightningProc2_4BAE60(a1 *int2, a2 *int2, a3 int32, a4 *int16, a5 int32, a6 int32, a7 int32) int32 {
	...
	*memmap.PtrUint32(6112660, 1316532) = uint32(a3)
	if a3 == 1 || a3 == 3 {
		*memmap.PtrUint16(6112660, 1316432) = uint16(*a4)
		*memmap.PtrUint16(6112660, 1316434) = uint16(*(*int16)(unsafe.Add(unsafe.Pointer(a4), unsafe.Sizeof(int16(0))*2)))
		v14 = a1.field_0
		v15 = a2.field_0
		...
		if v16 <= v19 {
			*memmap.PtrUint32(6112660, 1316500) = uint32(bool2int(v17 >= v18) + 2)
		} else {
			*memmap.PtrUint32(6112660, 1316500) = uint32(bool2int(v14 >= v15))
		}
		v7 = a2
	}
	...
	*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v21))), unsafe.Sizeof(uint16(0))*1)) = uint16(int16(v7.field_4))
	if a6 != 0 {
		...
		*memmap.PtrUint32(6112660, 1316508) = 0
	...
	if a7 != 0 {
		...
		*memmap.PtrUint32(6112660, 1316440) = dword_5d4594_1316484
		*memmap.PtrUint32(6112660, 1316508) = 1
...
func nox_thing_lightning_draw(a1 *int32, dr *nox_drawable) int32 {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 432)))) == 0 {
		...
		v4 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*5))
		v5 = *a1
		...
		if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Pointer(uintptr(a2 + 437)))) != 0 {
			v7 = nox_xxx_netSpriteByCodeStatic_45A720(int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 437)))))
		} else {
			v7 = nox_xxx_netSpriteByCodeDynamic_45A6F0(int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 437)))))
		}
		v8 = v7
		if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Pointer(uintptr(a2 + 441)))) != 0 {
			v9 = nox_xxx_netSpriteByCodeStatic_45A720(int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 441)))))
		} else {
			v9 = nox_xxx_netSpriteByCodeDynamic_45A6F0(int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 441)))))
		}
		if !(v8 != nil && v9 != nil) {
			return 1
		}
		v10 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*4))
		v11 = *a1 - v10
		a1a.field_0 = int32(uint32(*a1) + *(*uint32)(unsafe.Add(unsafe.Pointer(v8), unsafe.Sizeof(uint32(0))*3)) - uint32(v10))
		v12 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*5))
		v13 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*1))
		a1a.field_4 = int32(uint32(v13) + *(*uint32)(unsafe.Add(unsafe.Pointer(v8), unsafe.Sizeof(uint32(0))*4)) - uint32(v12) - 20)
		v18 = *(*int2)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v8), unsafe.Sizeof(uint32(0))*3))))
		a2a.field_0 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(uint32(0))*3)) + uint32(v11))
		a2a.field_4 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(uint32(0))*4)) - uint32(v12) + uint32(v13) - 20)
		a3 = *(*int2)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(uint32(0))*3))))
	}
	dword_5d4594_1316452 = *memmap.PtrUint32(6112660, 1316428)
	dword_5d4594_1316436 = *memmap.PtrUint32(6112660, 1316464)
	dword_5d4594_1316456 = *memmap.PtrUint32(6112660, 1316424)
	dword_5d4594_1316484 = *memmap.PtrUint32(6112660, 1316488)
	*memmap.PtrUint8(6112660, 1316420) = 1
	nox_xxx_lightningProc2_4BAE60(&a1a, &a2a, 2, nil, 1, 1, 1)
	if nox_xxx_checkGameFlagPause_413A50() == 0 {
		nox_xxx_makeLightningParticles_4999D0(*memmap.PtrInt32(6112660, 1316520), &v18, &a3)
	}
	return 1
}
func nox_thing_chain_lightning_bolt_draw(a1 *int32, dr *nox_drawable) int32 {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 432)))) == 0 {
		...
		*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v7))), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Pointer(uintptr(a2 + 439)))
		...
		v13 = *a1 - v12
		a1a.field_0 = int32(uint32(*a1) + *(*uint32)(unsafe.Add(unsafe.Pointer(v10), unsafe.Sizeof(uint32(0))*3)) - uint32(v12))
		...
		a1a.field_4 = int32(uint32(v15) + *(*uint32)(unsafe.Add(unsafe.Pointer(v10), unsafe.Sizeof(uint32(0))*4)) - uint32(v14) - 20)
		v19 = *(*int2)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v10), unsafe.Sizeof(uint32(0))*3))))
		a2a.field_0 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(uint32(0))*3)) + uint32(v13))
		a2a.field_4 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(uint32(0))*4)) - uint32(v14) + uint32(v15) - 20)
		a3 = *(*int2)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(uint32(0))*3))))
	}
	dword_5d4594_1316452 = *memmap.PtrUint32(6112660, 1316428)
	dword_5d4594_1316436 = *memmap.PtrUint32(6112660, 1316464)
	dword_5d4594_1316456 = *memmap.PtrUint32(6112660, 1316424)
	...
	*memmap.PtrUint8(6112660, 1316420) = 1
	nox_xxx_lightningProc2_4BAE60(&a1a, &a2a, 2, nil, 1, 1, 1)
	if nox_xxx_checkGameFlagPause_413A50() == 0 {
		nox_xxx_makeLightningParticles_4999D0(*memmap.PtrInt32(6112660, 1316520), &v19, &a3)
	}
	return 1
}
func nox_thing_energy_bolt_draw(a1 *int32, dr *nox_drawable) int32 {
	...
	if v3 {
		...
		v6 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*5))
		v7 = *a1
		v21 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*1))
		...
		if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Pointer(uintptr(v2 + 437)))) != 0 {
			v9 = nox_xxx_netSpriteByCodeStatic_45A720(int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 437)))))
		} else {
			v9 = nox_xxx_netSpriteByCodeDynamic_45A6F0(int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 437)))))
		}
		v10 = v9
		if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Pointer(uintptr(v2 + 441)))) != 0 {
			v11 = nox_xxx_netSpriteByCodeStatic_45A720(int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 441)))))
		} else {
			v11 = nox_xxx_netSpriteByCodeDynamic_45A6F0(int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 441)))))
		}
		if !(v10 != nil && v11 != nil) {
			return 1
		}
		...
		v14 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*5))
		v15 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*1))
		a1a.field_0 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v10), unsafe.Sizeof(uint32(0))*3)) + uint32(*a1) - uint32(v13))
		a1a.field_4 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v10), unsafe.Sizeof(uint32(0))*4)) - uint32(v14) + uint32(v15) - 20)
		v20 = *(*int2)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v10), unsafe.Sizeof(uint32(0))*3))))
		a2a.field_0 = int32(uint32(v12) + *(*uint32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(uint32(0))*3)) - uint32(v13))
		a2a.field_4 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(uint32(0))*4)) - uint32(v14) + uint32(v15) - 20)
		a3 = *(*int2)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(uint32(0))*3))))
	}
	*memmap.PtrUint8(6112660, 1316420) = uint8(int8((int32(v22) + math.MaxInt8) * 2))
	dword_5d4594_1316436 = *memmap.PtrUint32(6112660, 1316496)
	dword_5d4594_1316484 = *memmap.PtrUint32(6112660, 1316468)
	nox_xxx_lightningProc2_4BAE60(&a1a, &a2a, 2, nil, 0, 0, 1)
	if nox_xxx_checkGameFlagPause_413A50() == 0 {
		nox_xxx_makeLightningParticles_4999D0(*memmap.PtrInt32(6112660, 1316524), &v20, &a3)
	}
	return 1
}
func nox_thing_green_bolt_draw(a1 *int32, dr *nox_drawable) int32 {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 432)))) != 0 {
		if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Pointer(uintptr(a2 + 437)))) != 0 {
			v10 = nox_xxx_netSpriteByCodeStatic_45A720(int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 437)))))
		} else {
			v10 = nox_xxx_netSpriteByCodeDynamic_45A6F0(int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 437)))))
		}
		v11 = v10
		if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Pointer(uintptr(a2 + 441)))) != 0 {
			v12 = nox_xxx_netSpriteByCodeStatic_45A720(int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 441)))))
		} else {
			v12 = nox_xxx_netSpriteByCodeDynamic_45A6F0(int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 441)))))
		}
		if v11 == nil || v12 == nil {
			return 1
		}
		v13 = *a1
		v14 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*4))
		a1a.field_0 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(uint32(0))*3)) + uint32(*a1) - uint32(v14))
		v15 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*5))
		v16 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(int32(0))*1))
		a1a.field_4 = int32(uint32(v16) + *(*uint32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(uint32(0))*4)) - uint32(v15) - 20)
		v20 = *(*int2)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(uint32(0))*3))))
		a2a.field_0 = int32(uint32(v13) + *(*uint32)(unsafe.Add(unsafe.Pointer(v12), unsafe.Sizeof(uint32(0))*3)) - uint32(v14))
		a2a.field_4 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v12), unsafe.Sizeof(uint32(0))*4)) - uint32(v15) + uint32(v16) - 20)
		a3 = *(*int2)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v12), unsafe.Sizeof(uint32(0))*3))))
	} else {
	...
	dword_5d4594_1316452 = *memmap.PtrUint32(6112660, 1316444)
	dword_5d4594_1316436 = *memmap.PtrUint32(6112660, 1316504)
	dword_5d4594_1316456 = *memmap.PtrUint32(6112660, 1316460)
	dword_5d4594_1316484 = *memmap.PtrUint32(6112660, 1316480)
	*memmap.PtrUint8(6112660, 1316420) = 1
	nox_xxx_lightningProc2_4BAE60(&a1a, &a2a, 2, nil, 1, 1, 1)
	if nox_xxx_checkGameFlagPause_413A50() == 0 {
		nox_xxx_makeLightningParticles_4999D0(*memmap.PtrInt32(6112660, 1316528), &v20, &a3)
	}
	return 1
}
