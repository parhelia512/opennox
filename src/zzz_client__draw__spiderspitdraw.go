...
func nox_thing_spider_spit_draw(a1 *uint32, dr *nox_drawable) int32 {
	var (
		v2  *uint32
		v3  int32
		v4  int32
	...
	v4 = int32(*(*int16)(unsafe.Pointer(uintptr(a2 + 104))))
	v16 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(uint32(0))*1)))
	v13 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v2), unsafe.Sizeof(uint32(0))*4)))
	v5 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v2), unsafe.Sizeof(uint32(0))*3)))
	v12 = v4
	v6 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v2), unsafe.Sizeof(uint32(0))*8)))
	v7 = int32(uint32(v16+v13) - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(uint32(0))*5)) - uint32(v4))
	v14 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v2), unsafe.Sizeof(uint32(0))*9)))
	v8 = int32(*a1 + uint32(v6) - uint32(v3))
	v9 = int32(uint32(v5) + *a1 - uint32(v3))
	v10 = int32(uint32(v16+v14) - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(uint32(0))*5)) - uint32(v12))
	if v5-v6 >= 0 {
		v15 = v5 - v6
	} else {
		v15 = v6 - v5
