...
func nox_thing_spherical_shield_draw(a1 *int32, dr *nox_drawable) int32 {
	...
	v2 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a2), unsafe.Sizeof(uint32(0))*108)))
	if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Add(unsafe.Pointer(a2), unsafe.Sizeof(uint32(0))*108))) != 0 {
	...
	if v4 != nil {
		nox_xxx_updateSpritePosition_49AA90(dr, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v4), unsafe.Sizeof(uint32(0))*3))), int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v4), unsafe.Sizeof(uint32(0))*4))+3))
