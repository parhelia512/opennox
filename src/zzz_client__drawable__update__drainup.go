...
func sub_4CD690(a1 *uint32, a2 int32) int32 {
	var (
		v2  int32
		v3  int32
		v4  int32
	...
	if *memmap.PtrUint32(6112660, 1522976) == 0 {
		*memmap.PtrUint32(6112660, 1522976) = uint32(nox_xxx_getTTByNameSpriteMB_44CFC0("DrainManaOrb"))
	}
	if randomIntMinMax(0, 100) < 50 {
		...
		v17 = v2 + v15
		v18 = v3 + *(*int32)(unsafe.Add(unsafe.Pointer(v13), unsafe.Sizeof(int32(0))*1)) - v16 - v24
		if v17 < 0 {
			v2 = *(*int32)(unsafe.Add(unsafe.Pointer(v13), unsafe.Sizeof(int32(0))*4)) + v14 + 1
		}
		if v18 < 0 {
			v3 = v16 - v24 + *(*int32)(unsafe.Add(unsafe.Pointer(v13), unsafe.Sizeof(int32(0))*1)) + 1
		}
		if v17 >= *(*int32)(unsafe.Add(unsafe.Pointer(v13), unsafe.Sizeof(int32(0))*8)) {
			v2 = *(*int32)(unsafe.Add(unsafe.Pointer(v13), unsafe.Sizeof(int32(0))*2)) + *(*int32)(unsafe.Add(unsafe.Pointer(v13), unsafe.Sizeof(int32(0))*4)) - 1
		}
		if v18 >= *(*int32)(unsafe.Add(unsafe.Pointer(v13), unsafe.Sizeof(int32(0))*9)) {
			v3 = *(*int32)(unsafe.Add(unsafe.Pointer(v13), unsafe.Sizeof(int32(0))*3)) - v24 + v16 - 1
		}
		v19 = int32(uintptr(unsafe.Pointer(nox_xxx_spriteLoadAdd_45A360_drawable(*memmap.PtrInt32(6112660, 1522976), v2, v3))))
		if v19 != 0 {
