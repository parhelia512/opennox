...
int sub_4862E0(timer* a3, int a4);
uint32_t* sub_486320(timer* a1, int a2);
int sub_486350(timer* a1, int a2);
int sub_486380(timer* a1, unsigned int a2, int a3, int a4);
int sub_4863B0(timer* a2);
uint32_t* sub_4864A0(timerGroup* a3);
int sub_486520(timerGroup* a2);
int sub_486550(timerGroup* a1);
int sub_486570(timerGroup* a1, timerGroup* a2);
uint32_t* sub_486620(timerGroup* a1);
