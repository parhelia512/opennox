...
func sub_57AF30(a1 int32, a2 int32) {
	...
	if a2 != 0 {
		if a2 != 1 {
			...
			v3 = (*uint32)(unsafe.Pointer(nox_xxx_newObjectByTypeID_4E3810(CString("OblivionUp"))))
			v2 = int32(dword_5d4594_2523780)
			dword_5d4594_2523776 = uint32(uintptr(unsafe.Pointer(v3)))
		}
	} else {
		v3 = (*uint32)(unsafe.Pointer(nox_xxx_newObjectByTypeID_4E3810(CString("LevelUp"))))
		v2 = int32(dword_5d4594_2523780)
		dword_5d4594_2523776 = uint32(uintptr(unsafe.Pointer(v3)))
	}
	if v3 != nil {
	...
	if a2 == 0 {
		...
		v4 = strMan.GetStringInFile("expLevel.c:LevelUP", "C:\\NoxPost\\src\\common\\GameMech\\PauseFX.c")
	...
	if a2 != 0 {
		*memmap.PtrUint32(6112660, 2523796) = 0
		if a2 != 1 {
			goto LABEL_30
		}
	}
LABEL_29:
	*memmap.PtrUint32(6112660, 2523796) = 5000
LABEL_30:
	*memmap.PtrUint32(6112660, 2523800) = 0
	*memmap.PtrUint32(6112660, 2523772) = uint32(a2)
	dword_5d4594_2523804 = 1
	sub_413A00(1)
	*memmap.PtrUint64(6112660, 2523788) = uint64(platformTicks())
}
