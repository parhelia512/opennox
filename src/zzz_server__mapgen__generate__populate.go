...
func sub_527D50(a1 int32, a2 *byte) int32 {
	...
	if cgoFuncAddr(cgoAsFunc(*(*uint32)(unsafe.Pointer((*nox_objectType_t)(unsafe.Add(unsafe.Pointer(nox_xxx_objectTypeByID_4E3B60(v3)), unsafe.Sizeof(nox_objectType_t{})*212)))), (*func(int32) int32)(nil))) != cgoFuncAddr(nox_xxx_XFerExit_4F4B90) {
		return 0
	}
	libc.StrNCpy(*(**byte)(unsafe.Pointer(uintptr(a1 + 700))), a2, 80)
	return 1
}
...
func sub_526A90() {
	*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_2487672)) = nil
}
func nox_xxx_mapGenFinishPopulate_5228B0_mapgen_populate(a1 int32) {
	...
	if nox_xxx_mapGenMakeExit_522A40(a1) == 0 {
		v1 = strMan.GetStringInFile("NoExit", "C:\\NoxPost\\src\\Server\\MapGen\\Generate\\populate.c")
		nox_xxx_printToAll_4D9FD0(0, v1)
		v2 = strMan.GetStringInFile("NoExit", "C:\\NoxPost\\src\\Server\\MapGen\\Generate\\populate.c")
		nox_xxx_printToAll_4D9FD0(0, v2)
		v3 = strMan.GetStringInFile("NoExit", "C:\\NoxPost\\src\\Server\\MapGen\\Generate\\populate.c")
		...
		if *(*uint32)(unsafe.Pointer(uintptr(a1 + 60))) != 0 {
			for j = int32(*(*uint32)(unsafe.Pointer(uintptr(i + 368)))); j != 0; j = int32(*(*uint32)(unsafe.Pointer(uintptr(j + 24)))) {
				if *(*uint32)(unsafe.Pointer(uintptr(j))) != 0 {
					nox_xxx_tileGetDefByName_51D4D0(CString("CrystalBlue"))
				} else {
					nox_xxx_tileGetDefByName_51D4D0(CString("CrystalRed"))
				}
	...
	nox_xxx_mapGenGetObjID_527940(CString("PlayerStart"))
